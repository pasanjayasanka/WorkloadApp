...
public class DeviceIDConfig extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_device_i_d_config);

        ActivityHelper.initialize(this);
        // mBtnDisconnect = (Button) findViewById(R.id.btnDisconnect);
        btnConfig=(Button)findViewById(R.id.btnConfirm);
...
// TODO Auto-generated method stub
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(DeviceIDConfig.this, "Hold on", "Connecting");// http://stackoverflow.com/a/11130220/1287554
